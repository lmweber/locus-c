...
for (i in seq_along(sample_names)) {
  ...
  dir_outputs <- "/dcl02/lieber/ajaffe/SpatialTranscriptomics/LIBD/MiSeq_Pilot/outputs/NextSeq"
...
for (i in seq_along(sample_names)) {
  ...
  fn <- here("plots", "features_per_spot", paste0("QC_spots_huge_counts_", sample_names[i], ".png"))
  ggsave(fn, width = 4.75, height = 3.5)
  
  # plot counts as gradient
  ...
  fn <- here("plots", "features_per_spot", paste0("QC_counts_by_spot_", sample_names[i], ".png"))
  ggsave(fn, width = 4.75, height = 3.5)
}
```
