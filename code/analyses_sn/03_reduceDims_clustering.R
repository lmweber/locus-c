...
annotationTab.lc$cellType[c(5,14,17,19, 36,47,52, 53,60)] <-
  paste0("Neuron.ambig_", c("A","B","C","D", "E","F","G","H", "I"))

annotationTab.lc$cellType[c(3,8,10,13,18,20,41,43,49:51, 55,59)] <-
  paste0("Excit_", c("A","B","C","D", "E","F","G","H", "I","J","K","L","M"))
...
annotationTab.lc$cellType[46] <- c("Micro_CD163")
annotationTab.lc$cellType[c(6,29, 38,42,44)] <-
  paste0("Astro_", c("A","B","C","D","E"))
annotationTab.lc$cellType[c(11,33)] <- c("Endo_RBPMS","Endo")
annotationTab.lc$cellType[15] <- c("ambig.lowNTx")



sce.lc$cellType <- annotationTab.lc$cellType[match(sce.lc$clusters.glmcpcamnn,
...
#             3080              179              108               57               33 
#          Astro_E             Endo       Endo_RBPMS          Excit_A          Excit_B 
#               53              104               69              178              182 
#          Excit_C          Excit_D          Excit_E          Excit_F          Excit_G 
#              151              114              219              123              113 
#          Excit_H          Excit_I          Excit_J          Excit_K          Excit_L 
#               31               89               31               32               39 
#          Excit_M          Inhib_A          Inhib_B          Inhib_C          Inhib_D 
#               54               99              127              159              148 
#          Inhib_E          Inhib_F          Inhib_G          Inhib_H          Inhib_I 
#              255              137               50               49               46 
#          Micro_A          Micro_B          Micro_C      Micro_CD163       Neuron.5HT 
#               66               59               80               30               47 
...
Sys.time()
#[1] "2022-01-28 19:51:04 EST"
proc.time()
#     user    system   elapsed 
#  346.524   22.086 8000.808 
options(width = 120)
session_info()
# ─ Session info ─────────────────────────────────────────────────────────────────────
# setting  value
...
# pillar                 1.6.5    2022-01-25 [2] CRAN (R 4.1.2)
