...
Various strategies for segmenting LC region.

Previously tried spot-level cell type deconvolution methods here, but may not be necessary.
...
```{r, fig.width=3.75, fig.height=3.25}
# genes of interest
gns <- c("SNAP25", "SYT1", "TH", "GAD1", "MOG", "MOBP", "PDGFRA", "CSF1R", "C3", "GFAP", "GLI3")
