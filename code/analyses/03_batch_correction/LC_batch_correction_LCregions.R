...
dir_plots <- here("plots", "02_batch_correction", "LCregions")
...
# clustering on LC region spots without batch correction
...
fn_out <- here("processed_data", "SPE", "LC_batchCorrected_LCregions")
