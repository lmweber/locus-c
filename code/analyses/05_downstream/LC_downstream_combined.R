...
dir_plots <- here("plots", "05_downstream")
...
fn <- file.path(dir_plots, "LC_clusters_HARM")
...
fn <- file.path(dir_plots, "LC_clusters_PCA")
ggsave(paste0(fn, ".pdf"), width = 6.25, height = 5)
ggsave(paste0(fn, ".png"), width = 6.25, height = 5)
...
fn <- file.path(dir_plots, "LC_clusters_UMAP")
ggsave(paste0(fn, ".pdf"), width = 6.25, height = 5)
ggsave(paste0(fn, ".png"), width = 6.25, height = 5)
...
fn <- file.path(dir_plots, "LC_clusters_XYspace")
