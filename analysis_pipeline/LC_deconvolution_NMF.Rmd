...
```{r}
# load objects
dir_load <- "../processed_data"
file_load <- file.path(dir_load, "LC_SPE_list.RData")
load(file_load)
```
...
file_markers <- "../../marker_genes/marker_stats.Rdata"
load(file_markers)
```
...
Try our own method using non-negative matrix factorization (suggestion from Casey Greene).
