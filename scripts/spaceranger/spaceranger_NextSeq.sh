...
--fastqs=/dcl02/lieber/ajaffe/SpatialTranscriptomics/LIBD/locus-c/FASTQ/FASTQ_NextSeq/LC_1 \
...
--id=LC_2 \
--transcriptome=/dcl02/lieber/ajaffe/SpatialTranscriptomics/refdata-gex-GRCh38-2020-A \
--fastqs=/dcl02/lieber/ajaffe/SpatialTranscriptomics/LIBD/locus-c/FASTQ/FASTQ_NextSeq/LC_2 \
